...
| `configMap#namespace`                   | Allows customization of the configmap / nginx-configmap #namespace                                                                                  | `""`                                       |
| `tcpConfigMap#namespace`                | Allows customization of the tcp-services-configmap #namespace                                                                                       | `""`                                       |
| `udpConfigMap#namespace`                | Allows customization of the udp-services-configmap #namespace                                                                                       | `""`                                       |
